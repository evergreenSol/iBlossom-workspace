...
import com.kh.iblossom.common.bootpay.model.vo.request.Token;
import com.kh.iblossom.common.bootpay.model.vo.response.ResDefault;
import com.kh.iblossom.common.bootpay.model.vo.response.data.TokenData;
...
public class TokenService {
    static public ResDefault<HashMap<String, Object>> getAccessToken(BootpayObject bootpay) throws Exception {
        ...
        ResDefault<HashMap<String, Object>> res = new Gson().fromJson(str, resType);
        return res;
    }
}
