...
<body>
    ...
    <div class="wrap">
		...
		<div class="subscription">
	            ...
	            <table class="sub_list"> 
	               <!-- <c:forEach var="s" items="${ list }">--> <!-- SUB_PRODUCT 테이블로부터 읽어오기-->   
	                ...
	                <tr id="sub_list_product">
	                    <td height="250px" width="250px" id="sub_list_img"></td><!--<img src="${ s.subChangeName }"-->
	                    <td id="subproduct_name"><br><br>정기구독 상품 리스트에서 제목<!-- ${ s.subProductName }--></td>
	                </tr>
	            </table>
	            <br><br>
	        </div>
	        ...
	        <div class="sub_period" hidden>
	            ...
	            <table class="sub_period" border="1px solid black">
	                <tr>
	                    <td rowspan="6" width="360px;" height="400;"></td><!--<img src="${ s.subFilePath }" script에서 추가! -->
	                    <td colspan="2" height="50">첫 수령일을 선택하세요.<br>
	                        <input type="text" class="datepicker" id="datepicker" required>
	                    </td>
	                </tr>
	
	                <tr>
	                    <td colspan="2" height="50">구독기간을 선택해주세요.</td>
	                </tr>
	                <tr> <!-- 같은 function에 매개변수만 다르게 해서 넘겨주면 편할듯?-->
	                    <td height="90px"><button onclick="">정기결제</button></td>
	                    <td height="90px"><button onclick="">6개월</button></td>
	                </tr>
	                <tr>
	                    <td height="90px"><button onclick="">3개월</button></td>
	                    <td height="90px"><button onclick="">12개월</button></td>
	                </tr>
	                <tr>
	                    <td colspan="2"></td>
	                </tr>
	        ...
	        <div class="sub_product" hidden>
	            <h3>내가 고른 상품 정보</h3>
	            <table class="sub_product" border="1px solid black">
	                <tr>
	                    <td height="300px" width="500px" colspan="2"></td>
	                </tr>
	                <tr>
	                ...
	                <tr>
	                    <th height="50px" style="border-top:2px solid black">첫수령일</th>
	...
	$('#sub_list_product').click(function() {
        $('#sub_list_img').css("border","3px solid rgb(255,35,147)")
