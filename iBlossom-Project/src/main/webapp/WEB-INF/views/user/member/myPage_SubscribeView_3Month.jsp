...
<body>
	...
	<div class="mypage-subscribe" id="subscribe-3m-show" style="text-align: center">
	...
	<div id="subscribe-3m" class="subscribe-close">
		...
		<c:forEach var="i"  begin="0" end="${ list3m.size() -1 }" >
			<table>
	               ...
	               <tr>
	                   <th>구독내용</th>
	                   <td></td>
	                   <td class="subLevel">3개월 구독</td>
	               </tr>
	               <tr>
	                   <th>회차</th>
	                   <td></td>
	                   <!-- 만약에 구독개월스 컬럼이 0이면,  아래처럼 arraylist의 사이즈 뽑으면 될듯?-->
	                   <td>${i+1}회 / ${ list3m.size() }회</td>
		...
		<br><br>
			<div style="margin-bottom: 18px;">
				...
				<div class="mypage-subscribe-cancel-area" style="display:inline; margin-left: 595px;">
					...
					<input type="hidden" value="${ list3m[0].receiptId }" name="receiptId">
				</div>
			</div>
			<div style="width: 100%">
			...
			<input type="hidden" value="${ list3m[0].subLevel }" name="subLevel">
	...
	<script>
		$(function () {
			...
			var subPrice = ${ list3m[0].subPrice }
