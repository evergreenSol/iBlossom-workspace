...
<body>
    ...
    <div id="content-wrap">
        ...
        <div class="title"><p style="font-size: 17px; font-weight: 600;">어버이날 배송 안내</p>
...
TIME TO BLOSSOM
- I Blossom 드림.</pre><hr align="left" style="width: 100%;">

        <div class="title"><p style="font-size: 17px; font-weight: 600;">원데이 클래스 관련 공지</p>
            <div class="notice-date" name="" >2022-07-02</div>
        </div>
        <pre class="content1" style="font-size: 15px;">
...
- 단체수업 및 다른 장소로 출장을 원하실 경우 별도 문의 부탁드립니다.
        </pre><hr align="left" style="width: 100%;">

        <div class="title"><p style="font-size: 17px; font-weight: 600;">#IBlossom #2022</p>
            <div class="notice-date" name="" >2022-07-02</div>
        </div>
        <pre class="content1" style="font-size: 15px;">
